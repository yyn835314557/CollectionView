...
//1. struct wraps up a search terms and results found for that search
struct FlickrSearchResults {
  let searchTerm : String
  let searchResults : [FlickrPhoto]
}

//2. Data about a photo retrieved from Flickr include metadata(元数据) etc.
...
//3. provide block-based API to perform search and return a FlickSearchResult
class Flickr {
